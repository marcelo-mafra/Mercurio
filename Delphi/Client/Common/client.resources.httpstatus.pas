...
unit client.resources.httpstatus;
 ...
 type
  ...
  THTTPStatus = class
   const
    ...
    public
     class function ToText(const AStatusCode: integer): string;
  end;
...
class function THTTPStatus.ToText(const AStatusCode: integer): string;
begin
  case AStatusCode of
